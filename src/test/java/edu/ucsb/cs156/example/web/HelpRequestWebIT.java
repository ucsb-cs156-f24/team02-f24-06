...
public class HelpRequestWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_help_request() throws Exception {
        ...
        page.getByTestId("HelpRequestForm-requesterEmail").fill("tester@ucsb.edu");
        page.getByTestId("HelpRequestForm-teamId").fill("f24-5pm-11");
        page.getByTestId("HelpRequestForm-tableOrBreakoutRoom").fill("6");
        page.getByTestId("HelpRequestForm-requestTime").fill("2024-12-30T01:20");
        page.getByTestId("HelpRequestForm-explanation").fill("testing test");
        ...
        assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-requesterEmail"))
                .hasText("tester@ucsb.edu");

        page.getByTestId("HelpRequestTable-cell-row-0-col-Edit-button").click();
        assertThat(page.getByText("Edit Help Request")).isVisible();
        page.getByTestId("HelpRequestForm-explanation").fill("changed explanation");
        page.getByTestId("HelpRequestForm-submit").click();

        assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-explanation")).hasText("changed explanation");
