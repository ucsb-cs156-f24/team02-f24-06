...
public class ArticlesIT {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                Articles article1 = Articles.builder()
                                ...
                                .dateAdded(LocalDateTime.parse("2022-06-15T10:00:00"))
                                .build();
        ...
        public void an_admin_user_can_post_a_new_article() throws Exception {
                ...
                Articles article2 = Articles.builder()
                                ...
                                .explanation("This is a sample explanation for the second article.")
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/articles/post?title=Sample Article Title&url=https://samplewebsite.com/article2&explanation=This is a sample explanation for the second article.&email=sampleauthor2@example.com&dateAdded=2022-06-15T10:00:00")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
