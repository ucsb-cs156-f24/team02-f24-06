...
public class UCSBOrganizationIT {
    ...
    public void an_admin_user_can_post_a_new_org() throws Exception {
        ...
        UCSBOrganization org1 = UCSBOrganization.builder()
            .orgCode("TASA")
            .orgTranslationShort("TASA")
            .orgTranslation("Taiwanese%20American%20Student%20Association")
            .inactive(false)
            .build();

        // act
        MvcResult response = mockMvc.perform(
            post("/api/ucsborganizations/post?orgCode=TASA&orgTranslationShort=TASA&orgTranslation=Taiwanese%20American%20Student%20Association&inactive=false")
                .with(csrf()))
