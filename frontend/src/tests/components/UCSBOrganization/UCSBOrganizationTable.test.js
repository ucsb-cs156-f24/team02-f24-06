...
describe("UCSBOrganizationTable tests", () => {
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    ).toHaveTextContent("Taiwanese American Student Association");
    expect(
    ...
    ).toHaveTextContent("Institute of Electrical and Electronics Engineers");
    expect(
  ...
  test("Edit button navigates to the edit page", async () => {
    ...
    await waitFor(() =>
      expect(mockedNavigate).toHaveBeenCalledWith("/ucsborganization/edit/TASA"),
    );
  });
  ...
  test("Delete button calls delete callback", async () => {
    ...
    expect(axiosMock.history.delete[0].params.orgCode).toBe("TASA");
  });
});
